...
public class TestLectorAlum {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//Se va a comprobar la cadena retornada por histórico, se quitan los espacios en blanco 
			//y saltos de línea
			
			if (lector.listarHistorico().replaceAll("\\s","").equals("Elquijote2ªedición,Elquijote")){
